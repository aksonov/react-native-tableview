...
- Use tableview as menu to navigate to other app screen, see updated demo with Flux router usage (https://github.com/aksonov/react-native-router-flux)
...
## For demo, check examples/TableViewDemo iOS project
